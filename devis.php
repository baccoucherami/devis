...
<body>
   <header id="header">
				<h1><a href="index.php">TANGORYTHM</a></h1>
				<nav id="nav">
					<ul>
...
{
?>
    Produit: <input type="text" name="<?php echo 'nom'.$i ;?>" value="<?php echo $donnees['nom_produit']; ?>"  >
    prix en DT :<input type="text" name="<?php echo 'prix'.$i ;?>" value="<?php echo $donnees['prix_produit']; ?>" >
				...
				<div class="container">
					...
					<div class="row">
						<div class="8u 12u$(medium)">
							<ul class="copyright">
								<li>&copy; Rami Baccouche. All rights reserved.</li>
							</ul>
						</div>
